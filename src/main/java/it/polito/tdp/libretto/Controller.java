...
public class Controller {
	...
	private Libretto model; //controller non deve mai fare new del modello, il controller riceve dal main
    ...
    void handleInserisci(ActionEvent event) {
    	...
    	Voto voto = new Voto(corso,punti,date);
    	this.model.add(voto);
    ...
    void initialize() {
        ...
        assert txtResult != null : "fx:id=\"tetxResult\" was not injected: check your FXML file 'main.fxml'.";
